...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('D:/boilerplate-demographic-data-analyzer-main/adult.data.csv')
    ...
    lower_education = df[~df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])] # THE TILDE SIGN MEANS LOGICAL NOT.
